...
<body class="bg-light">
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shsdow-sm mb-4">
                    <div class="card-body">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="site-title" id="site-title_inp"
                                            class="form-control shadow-none" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">About us</label>
                                        <textarea name="site-about" id="site-about_inp" class="form-control" rows="6"
                                            required></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <iframe id="iframe" class="boder p-2 w-100" loading="lazy"></iframe>
                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="insts" id="insta_inp"
                                                            class="form-control shadow-none" required>
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-addon1"><i
                ...
                <div class="card border-0 shsdow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal"
                                data-bs-target="#team-s"><i class="bi bi-plus-square"></i>
                                Add
                            </button>
                        </div>
    ...
    function get_general() {
        ...
        let shutdown_toggle = getElementById('shutdown-toggle');
    ...
    general_s_form.addEventListner('submit', function(e) {
        e.preventDefault();
    ...
    function get_contacts() {
        ...
        xhr.onload = function() {
            ...
            contact_data = Object.values(contacts_data);
    ...
    function contacts_inp(data) {
        let contacts_inp_id = ['address_inp', 'gmap_inp', 'pn1_inp', 'pn2_inp', 'email_inp', 'fb_inp', 'tw_inp',
            'insta_inp', 'iframe_inp'
        ];

        for (i = 0; i < contacts_inp_id.length; i++) {
            document.getElemenrById(contacts_inp_id[i]).value = data[i + 1];
        }
    }

    contacts_s_form.addEventListner('submit', function(e) {
        e.preventDefault();
        upd_contacts();
    });
    ...
    team_s_form.addEventListner('submit', function(e) {
        e.preventDefault();
        add_member();
    });
